      ...
      <div className="flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-6 md:mb-0 order-2 md:order-1">
          <h2 className="text-2xl md:text-3xl font-bold font-heading mb-4 text-text">
            {isEnglish ? "Stories That Feed the Imagination" : "Estórias que Alimentam a Imaginação"}
          </h2>
          <p className="text-lg mb-6 text-gray-700">
            {isEnglish 
              ? "At Steloos, each story is an adventure that teaches important values in a fun and engaging way."
          ...
          <ul className="space-y-3 mb-6">
            <li className="flex items-start">
              ...
              <span className="text-gray-700">
                {isEnglish 
                  ? "Stories that teach about love and compassion" 
                  : "Estórias que ensinam sobre amor e compaixão"}
              </span>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0 w-6 h-6 bg-primary rounded-full flex items-center justify-center mr-3 mt-1">
              ...
              <span className="text-gray-700">
                {isEnglish 
                  ...
                  : "Ilustrações coloridas e encantadoras"}
              </span>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0 w-6 h-6 bg-primary rounded-full flex items-center justify-center mr-3 mt-1">
              ...
              <span className="text-gray-700">
                {isEnglish 
                  ...
                  : "Conteúdo apropriado para diferentes idades"}
              </span>
            </li>
          </ul>
          <Button 
          ...
          >
            <Link href={isEnglish ? "/stories" : "/estorias"}>
        ...
        <div className="md:w-1/2 order-1 md:order-2 floating">
          <img 
            ...
            alt={isEnglish ? "Children reading books in a colorful environment" : "Crianças lendo livros em um ambiente colorido"} 
