      ...
      <div className="flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-6 md:mb-0 order-2 md:order-1">
          <h2 className="text-2xl md:text-3xl font-bold font-heading mb-4 text-text">
            Histórias que Alimentam a Imaginação
          </h2>
          <p className="text-lg mb-6 text-gray-700">
            Em Estrelinha de Luz, cada história é uma aventura que ensina valores importantes de forma divertida e cativante.
          </p>
          <ul className="space-y-3 mb-6">
            <li className="flex items-start">
              ...
              <span className="text-gray-700">Histórias que ensinam sobre amor e compaixão</span>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0 w-6 h-6 bg-primary rounded-full flex items-center justify-center mr-3 mt-1">
                <Check className="text-white h-3 w-3" />
