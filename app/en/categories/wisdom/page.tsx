  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-[#9333EA] text-white rounded-lg p-8 mb-8">
        <h1 className="text-3xl font-bold mb-4 font-heading">Category: Wisdom</h1>
        <p className="text-lg opacity-90 max-w-2xl">
          Stories that teach about wisdom, knowledge, and discernment.
        </p>
      </div>
        ...
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="story-card">
            ...
            <div className="story-card-content">
              <h3 className="font-semibold mb-2">Wisdom Story {i}</h3>
              <p className="text-[#666666] text-sm mb-4">
                A story about wisdom and knowledge that teaches important values to children...
              </p>
              <a
                href={`/en/stories/${i}`}
