      ...
      <div className="max-w-3xl w-full text-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-[#333333] font-heading">
            Parece que você se perdeu nas estrelas!
          </h2>
          ...
          <div className="mb-6">
            ...
            <p className="text-[#666666] text-lg mb-4">
              A página que você está procurando parece ter viajado para outra galáxia.
            </p>
            
            <p className="text-[#666666]">
              Não se preocupe! Vamos te levar de volta para a página inicial em <span className="font-bold text-[#FF9D5C]">{countdown}</span> segundos.
            </p>
          </div>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/" className="bg-[#FF9D5C] text-white px-6 py-3 rounded-md hover:bg-[#F08C4B] transition-colors">
              Voltar para a Página Inicial
            </Link>
            <Link href="/estorias" className="bg-[#6366F1] text-white px-6 py-3 rounded-md hover:bg-[#4F46E5] transition-colors">
              Explorar Estórias
            </Link>
          </div>
        </div>
        ...
        <div className="text-[#666666]">
          <p>
            Enquanto isso, que tal ler uma de nossas estórias encantadoras?
          </p>
        </div>
      </div>
    </div>
